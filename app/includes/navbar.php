...
<div class="usernav"  style="font-family: 'Abel', sans-serif;">
    <?php
    ...
    <div class="globalsearch">
        <form method="get" action="search.php" onsubmit="return validateField()" style="padding-left:5px">
            <input type="text" placeholder="Search" name="query" id="query"><input type="submit" value="Search" id="querybutton">
        </form>
    </div>
</div>
